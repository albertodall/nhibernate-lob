...
namespace NHibernate.Lob
{
	public class XlobType : AbstractLobType, IParameterizedType
	{
		...
		public override bool Equals(object obj)
		{
			...
			var xt = obj as XlobType;
			if (compression == xt.compression) return true;
			return compression != null && compression.Equals(xt.compression);
		}
